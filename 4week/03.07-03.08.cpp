...
class IPv4
{
    ...
    friend bool operator<(IPv4 const & first, IPv4 const & second){
        return first.to_ulong() < second.to_ulong();
    }

    friend bool operator>(IPv4 const & first, IPv4 const & second){
        return second.to_ulong() < first.to_ulong();
    }
    ...
    friend bool operator==(IPv4 const & first, IPv4 const & second) noexcept{
